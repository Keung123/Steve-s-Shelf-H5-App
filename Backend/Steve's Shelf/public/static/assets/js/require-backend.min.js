...
require.config({
    ...
    paths: {
        ...
        'bootstrap-typeahead': '../libs/bootstrap-typeahead/bootstrap3-typeahead.min',
        ...
        api: {
            ...
            bindevent: function (table) {
                ...
                $(toolbar).on('click', Table.config.addbtn, function () {
                    ...
                    var ids = Table.api.selectedids(table);
                    Fast.api.open(options.extend.add_url + (options.extend.add_url.match(/(\?|&)+/) ? "&ids=" : "?ids=") + ids.join(","), __('Add'),{area:area});
                });
                // 批量编辑按钮事件
                $(toolbar).on('click', Table.config.editbtn, function () {
                    ...
                    $.each(ids, function (i, j) {
                        Fast.api.open(options.extend.edit_url + (options.extend.edit_url.match(/(\?|&)+/) ? "&ids=" : "?ids=") + j, __('Edit'),{area:area});
                    });
                });
                // 批量操作按钮事件
                ...
                $(table).on("click", "[data-id].btn-edit", function (e) {
                    ...
                    Fast.api.open(options.extend.edit_url + (options.extend.edit_url.match(/(\?|&)+/) ? "&ids=" : "?ids=") + $(this).data("id"), __('Edit'),{area:area});
                });
            ...
            events: {
                operate: {
                    'click .btn-editone': function (e, value, row, index) {
                        ...
                        Fast.api.open(options.extend.edit_url + (options.extend.edit_url.match(/(\?|&)+/) ? "&ids=" : "?ids=") + row[options.pk], __('Edit'),{area:area});
                    },
                    ...
                    Upload.list[id] = new Plupload.Uploader({
                        ...
                        init: {
                            ...
                            Error: function (up, err) {
                                Toastr.error(__(err.message) + "(code:" + err.code + ")");
                            }
                        }
                    });
...
$.fn.addtabs = function (options) {
    ...
    $(options.monitor).on('click', '[addtabs]', function (e) {
        if ($(this).attr('url').indexOf("javascript") !== 0) {
            ...
            if (false && history.pushState && !$(this).data("pushstate")) {
                try {
