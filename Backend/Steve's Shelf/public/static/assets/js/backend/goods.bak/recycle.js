        ...
        add: function () {
            ...
            var tableCreate=function(){
                ...
                if(b){//必选的SKU属性已经都选中了
                    ...
                    SKUTableDom += '<th>销售价</th><th>库存</th><th>成本价</th><th>编号</th><th>图片</th>';
                    SKUTableDom += "</tr>";
                    ...
                    for(var i = 0 ; i < totalRow ; i ++){//总共需要创建多少行
                        ...
                        //销售价
                        SKUTableDom += '<td><input style="width:80px;" name="sku['+name+'][price]" value="'+prices+'" class="form-control" type="text"/></td>';
                        //库存
                        SKUTableDom +='<td><input style="width:80px;" name="sku['+name+'][stock]" value="'+ stocck +'" class="form-control" type="text"/></td>';
                        //成本价
                        SKUTableDom += '<td><input style="width:80px;" name="sku['+name+'][cost_price]" value="'+cost_prices+'" class="form-control" type="text"/></td>';
                        //商家编码
                        SKUTableDom +='<td><input style="width:80px;" name="sku['+name+'][code]" value="'+codes+'" class="form-control" type="text"/></td>';
                        //规格图片
