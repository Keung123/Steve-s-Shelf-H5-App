            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'goods_numbers', title: __('产品编码'), align: 'left'},
                        {field: 'volume', title: __('volume'), align: 'left'},
                        {field: 'show_price', title: __('展示价'), align: 'left'},
                        {field: 'cost_price', title: __('成本价'), align: 'left'},
                        {field: 'price', title: __('平台价'), align: 'left'},
                        ...
                        {field: 'exchange_integral', title: __('兑换积分'), operate: false},
                        ...
                        {field: 'operate', title: __('Operate'), events: Controller.api.events.operate, formatter:function(value, row, index){
							...
							if(row.status=='回收站'){
								...
								html.push('<a href="javascript:;" class="btn btn-danger btn-remove btn-xs"><i class="fa fa-trash"></i></a>');
							}else{
            ...
            var tableCreate=function(){
                ...
                if(b){//必选的SKU属性已经都选中了
                    ...
                    for(var i = 0 ; i < totalRow ; i ++){//总共需要创建多少行
                        ...
                        //销售价
                        SKUTableDom += '<td><input style="width:65px;" name="sku['+name+'][price]" value="'+prices+'" class="form-control" type="text"/></td>';
                        //库存
