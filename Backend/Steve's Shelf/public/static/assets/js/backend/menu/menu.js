            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'icon', title: __('Image'), operate: false, formatter: Table.api.formatter.image},
        ...
        add: function () {
            ...
            var tableCreate=function(){
                ...
                if(b){//必选的SKU属性已经都选中了
                    ...
                    SKUTableDom += '<th>销售价</th><th>展示价</th><th>库存</th><th>成本价</th><th>重量(kg)</th><th>编号</th><th>图片</th>';
                    SKUTableDom += "</tr>";
